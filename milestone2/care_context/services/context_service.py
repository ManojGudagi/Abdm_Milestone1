...
def link_care_context_service(payload_data: dict, hip_id: str, link_token: str) -> tuple[dict, int]:
    api_url = "https://dev.abdm.gov.in/api/hiecm/hip/v3/link/carecontext"
    ...
    headers = {
        ...
        "X-CM-ID": "sbx",
        "X-HIP-ID": hip_id,
        "X-LINK-TOKEN": link_token  # ✅ Passed dynamically
    }
    ...
    try:
        ...
        return {"message": "Care Context Linked (ABDM returned empty 202 response)"}, res.status_code
